...
db = MySQLdb.connect(host="172.16.32.222", # your host, usually localhost
        user="aurora", # your username
        passwd="1Keyes", # your password
        db="aurora_main") # name of the data base
